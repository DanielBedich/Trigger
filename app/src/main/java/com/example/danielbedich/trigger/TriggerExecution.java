...
/*    Intent call = new Intent(Intent.ACTION_CALL);
    call.setClassName("com.example.danielbedich.TriggerExecution", "com.example.danielbedich.CreateActivity");
    call.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    call.setData(Uri.parse("tel:" +intent.getStringExtra("Num")));
    if (PackageManager.PERMISSION_GRANTED == context.checkCallingOrSelfPermission(Manifest.permission.CALL_PHONE)) {
